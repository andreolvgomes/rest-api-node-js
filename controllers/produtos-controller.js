...
controllers.produtos = (req, res, next) => {
...
// insert produtos
controllers.novo = (login.obrigatorio, upload.single('produto_imagem'), (req, res, next) => {
...
// get onde produto
controllers.produto = ('/:id_produto', (req, res, next) => {
...
// update produtos
controllers.update = ('/', login.obrigatorio, (req, res, next) => {
...
// delete produtos
controllers.delete = ('/', login.obrigatorio, (req, res, next) => {
